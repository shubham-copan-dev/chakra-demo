...
import { Box, Button, Heading, Image, Link, ListItem, Text, UnorderedList } from '@chakra-ui/react';
...
function MenuOffCanvas() {
  ...
  return (
    <Box>
      <Button type="button" onClick={isOpen} className="slider-control border-0 bg-transparent p-0">
      ...
      <Slider isOpen={isOffcanvasOpen} onClose={onClose}>
        <Box className="left-col" maxW="400px">
          ...
          {items.map((item: { title: any; content: any; imagesrc: any; description: any }) => (
              ...
              <UnorderedList className="p-0 slider-list" ms={0}>
                ...
                >
                  <Box className="item-icon">
                    <Image src={item.imagesrc} alt="image" width={30} height={30} />
                  </Box>
                  ...
                  <Image src="/images/right-arrow.svg" alt="arrow" className="right-arrow" />
                </ListItem>
              </UnorderedList>
            </Box>
          ))}
        ...
        {sidenavData !== null && (
          ...
          >
            <Box className="d-flex gap-3 sidenav-header">
              <Image src={sidenavData.imagesrc} alt="image" width={50} height={50} />
            ...
            <Box className="row pt-4">
              {sidenavData.data.map((item: { datahead: any; datadescription: any }) => (
                <Link
                  href="hello"
                  className="d-flex flex-column col-6 mb-4 p-4 sidenav-content"
                  maxW="300px"
                  _hover={{ textDecoration: 'none', bg: 'bgClr.LightLow', borderRadius: 'normal' }}
                >
                  <Text
                    m="0"
                    fontSize="sm"
